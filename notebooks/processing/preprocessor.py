...
if __name__ == "__main__":
    ...
    input_data_path = os.path.join("/opt/ml/processing/input", "dataset.parquet")
    ...
    print("Saving validation labels to {}".format(test_data_output_path))
    test_data.to_csv(test_data_output_path, index=False, header=True, columns=test_columns, sep=",")
